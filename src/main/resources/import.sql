...
INSERT INTO users (user_name, numIdentification, typeDoc, names, lastNames, address, phoneNumber, email, gender, password, dateRegister, lastModification, eliminated, role) VALUES ('juanito', 1031805187, 'CC', 'Juan', 'Pineda', 'Calle 134 #89', 3222275429, 'juanitopulgas@mail.com', 'MASCULINO', '$2a$10$iZB7HNKo8Sg9ERfmYEQCl.jNJiUFaJUhS.9dAat.uNDVyvn627rai', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'FINANCIAL_MANAGER');

-- Insert para un usuario con rol INVENTORY_MANAGER
INSERT INTO users (user_name, numIdentification, typeDoc, names, lastNames, address, phoneNumber, email, gender, password, dateRegister, lastModification, eliminated, role) VALUES ('ramiro', 19063224, 'CC', 'Ramiro', 'Martinez', 'Calle 99a #8-0', 3105793409, 'ramirin@mail.com', 'MASCULINO', '$2a$10$iZB7HNKo8Sg9ERfmYEQCl.jNJiUFaJUhS.9dAat.uNDVyvn627rai', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'INVENTORY_MANAGER');

-- Insert para un usuario con rol SALESPERSON
INSERT INTO users (user_name, numIdentification, typeDoc, names, lastNames, address, phoneNumber, email, gender, password, dateRegister, lastModification, eliminated, role) VALUES ('rLopez', 1047987456, 'CC', 'Roberto', 'Lopez', 'Carrera 15 #45-06', 312465876, 'rlopez@mail.com', 'MASCULINO', '$2a$10$N7uH4BW51DAPzOeK/Ju/Fu1BW68dV59QpLZ7jWwwA2uKhmyIQD3TS', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'SALESPERSON');
